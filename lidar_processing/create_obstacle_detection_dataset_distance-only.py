...
def get_obstacles_description(pcd_path):
    ...
    textual_obstacles_description = pc_interpreter.obstacle_distances_to_text(obstacles_description)     # return for the LLM to understand: this contains distance description only
...
if __name__ == "__main__":
    ...
    for type, dir in dirs.items():
        ...
        create_csv_file(dir, f"../V2X-R/distance-only-description/{type}.csv")
        logging.info("Done.")
